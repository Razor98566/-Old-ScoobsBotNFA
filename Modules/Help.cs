...
{
    //I have no idea what exactly happens here, I just happen to have found this at the Discord.net Discord server, I think I changed what's necessary for this to be ok to use
        ...
        public async Task Help(string path = "")
        {
            ...
            else
            {
                ...
                output.Description = $"{mod.Summary}\n" +
                                     ...
                                     (mod.Submodules.Any()
                                         ? $"Submodules: {mod.Submodules.Select(m => m)}\n"
                                         : "") + " ";
